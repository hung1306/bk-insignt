      ...
      <View style={[styles.Tinblock]}>
        <Pressable onPress={() => navigation.navigate("Calendar3")}>
          <View style={[styles.Tin1]}>
            ...
            <Text style={[styles.tin1Container, styles.thngTypo]}>
              ...
              chuẩn bị cho giải đấu Báo Thanh Niên 2024 sân 11 tổ chức...
            </Text>
          </View>
        </Pressable>
        ...
        <Pressable onPress={() => navigation.navigate("Calendar3")}>
          <View style={[styles.Tin2]}>
            <Text style={[styles.tin2Container, styles.thngTypo]}>
              Học bổng do công ty BOOSCH tài trợ lên đến 100 triệu đồng dành cho
              các học sinh có thành tích học tập xuất sắc và ...
            </Text>
        ...
        <Pressable onPress={() => navigation.navigate("Calendar3")}>
          <View style={[styles.Tin3]}>
            ...
            <Text style={[styles.tin3Container, styles.thngTypo]}>
              Thông báo tất cả sinh viên toàn trường tất cả các khóa tham gia
              sinh hoạt công dân HK231, đối với K20 sẽ tham gia vào ngày...
            </Text>
          </View>
        </Pressable>
        ...
        <Pressable onPress={() => navigation.navigate("Calendar3")}>
          <View style={[styles.Tin5]}>
            ...
            />
            <Text style={[styles.tin1Container, styles.thngTypo]}>
              Biện pháp phòng ngừa Covid 19 phải được tuân thủ trong toàn bộ
              khuôn viên một cách nghiêm ngặt và rõ ràng theo tư vấn...
            </Text>
          </View>
        </Pressable>
      </View>
