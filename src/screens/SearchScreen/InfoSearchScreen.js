        ...
        <View style={[styles.profilepage]}>
            <View style={styles.Headercontainer}>
                ...
                <View style={[styles.headerTextCon]}>
                    <Text style={styles.headerText}>HCMUT Football Club</Text>
                </View>
            </View>
            <View>
            <Text style={styles.hcmutFootballClub1}>HCMUT Football Club</Text>
            <Image
            ...
            <View style={styles.settingsContainer}>
                ...
                showsHorizontalScrollIndicator={false}>
                    ...
                    <Image 
                        ...
                        <Text style={styles.settingText2}>Trang - Đội thể thao của trường</Text>                         
                        </View>        
                    ...
                    <Image 
                            ...
                            />
                        <View style={styles.text2Con}>
                        <Text style={[styles.settingText2, { color: '#0077cc' }]}>hcmut.edu.vn</Text>                           
                            </View>
