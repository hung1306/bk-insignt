...
export const InfoSearchScreen3 = () => {
        ...
        <View style={[styles.profilepage]}>
            <View style={styles.Headercontainer}>
                ...
                <View style={[styles.headerTextCon]}>
                    <Text style={styles.headerText}>Câu lạc bộ đá banh khoa Điện</Text>
                </View>
            </View>
            <View>
            <Text style={styles.hcmutFootballClub1}>CLB đá banh khoa Điện</Text>
            <Image
                source={require('../../../assets/Search/background3.png')}
                resizeMode="cover"
                style={styles.image53Icon}
              />
              <Image
                source={require('../../../assets/Search/dabanhddt.png')}
            ...
            <View style={styles.settingsContainer}>
                ...
                showsHorizontalScrollIndicator={false}>
                    ...
                    <Image 
                        ...
                        <Text style={styles.settingText2}>Trang - CLB đá banh khoa điện</Text>                         
                        </View>        
                    ...
                    <Image 
                            ...
                            />
                        <View style={styles.text2Con}>
                        <Text style={[styles.settingText2, { color: '#0077cc' }]}>dabanhhcmut.edu.vn</Text>                           
                            </View>
